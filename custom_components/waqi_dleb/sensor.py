...
SENSOR_DESC_AQI = SensorEntityDescription(
    ...
    try:
        for location_name in locations:
            ...
            for station in stations:
                waqi_sensor = WaqiSensor(client, station, SENSOR_DESC_AQI)
                if (
                    not station_filter
                    or {
                        waqi_sensor.uid,
...
class WaqiSensor(SensorEntity):
    ...
    def __init__(self, client, station, description: SensorEntityDescription):
